...
class Economy:
    ...
    def population_shock(self, shock_size, shock_t):
        """
        (int, float, float, float, float) -> list
        ...
        """
        k_list_preshock = self.capital_capita(t=shock_t)
        time_left = self.time - shock_t
        k_list_postshock = self.capital_capita(t=time_left)
        return k_list_postshock
